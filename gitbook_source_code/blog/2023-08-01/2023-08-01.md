...
However, it is interesting to note that even when the number of hacks are nearly double of hacks, the financial impact of scams are less significant than the ones related to the hacks. The total financial loss of hacks ($35m) is nearly half of the loss to scams ($66m), as shown below in Figure 6 below.
