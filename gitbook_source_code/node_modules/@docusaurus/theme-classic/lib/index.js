...
exports.validateThemeConfig = exports.getSwizzleConfig = exports.AnnouncementBarDismissStorageKey = void 0;
...
const noFlashColorMode = ({ defaultMode, respectPrefersColorScheme, }) => `(function() {
...
function themeClassic(context, options) {
    ...
    return {
        ...
        getClientModules() {
            ...
            if (customCss) {
                modules.push(...(Array.isArray(customCss) ? customCss : [customCss]).map((p) => path_1.default.resolve(context.siteDir, p)));
            }
            return modules;
        },
        configureWebpack() {
